...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-pyright py-isort poetry pyenv-mode blacken smartparens-config doom-themes helpful beacon undo-tree restart-emacs projectile nord-theme magit counsel)))
(custom-set-faces
